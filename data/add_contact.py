...
constant = [
    Contact(first_name="first_name1", last_name="last_name1", address="address1",
            phone_home="phone_home1", phone_mobile="phone_mobile1", phone_work="phone_work1",
            email="email1", email2="email21", email3="email31"),
    Contact(first_name="first_name2", last_name="last_name2", address="address2",
...
testdata = [Contact(first_name="", last_name="", address="",
                      ...
                      email="", email2="", email3="")] + [
    Contact(first_name=random_string("first_name", 10), last_name=random_string("header", 20),
